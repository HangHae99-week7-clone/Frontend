        ...
        <>
          <DetailHeader>
            ...
            <CommonColumnBox>
              ...
              <CommonRowBox>
                {detailState.keyword.length !== 0 ? detailState.keyword.map((elem, idx) => <span key={idx} style={{color:"#1565c0", marginTop:"0.5rem", marginRight:"1rem"}}>{elem === undefined || elem === "" ? "" : `#${elem}`}</span>) : <></>}
              </CommonRowBox>
